...
/**
 * This endpoint returns the total number of logged events binned by hour
 */

use function CleanAnalytics\getAllRecords;
use function CleanAnalytics\getHourlyCounts;
use function CleanAnalytics\reportAllErrors;
...
echo json_encode(
    [
        ...
        "record-count-by-hour" => $hourlyCounts,
    ]
);
