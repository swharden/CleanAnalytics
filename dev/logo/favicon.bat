...
convert -background transparent logo.svg -resize 512x512 favicon-512.png
convert -background transparent logo.svg -resize 256x256 favicon-256.png
convert -background transparent logo.svg -resize 192x192 favicon-192.png
